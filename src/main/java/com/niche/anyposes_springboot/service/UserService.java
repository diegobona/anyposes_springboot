package com.niche.anyposes_springboot.service;
...
import com.niche.anyposes_springboot.mapper.UserMapper;
...
public class UserService extends ServiceImpl<UserMapper,User> {
    ...
    public String findMembertypeByUser(Integer userId) {
        return userMapper.findMemebertypeByUserId(userId);
    }
